package com.geely.common.utils.rsa;
...
public class RSAUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String str = "站在大明门前守卫的禁卫军，事先没有接到\n" + "有关的命令，但看到大批盛装的官员来临，也就\n" + "以为确系举行大典，因而未加询问。进大明门即\n" + "为皇城。文武百官看到端门午门之前气氛平静，\n" + "城楼上下也无朝会的迹象，既无几案，站队点名\n" + "的御史和御前侍卫“大汉将军”也不见踪影，不免\n"
                + "心中揣测，互相询问：所谓午朝是否讹传？我的上一篇博客《25行代码实现完整的RSA算法》自从上个月发表了以后，很多程序员给我打电话或者发短信说，终于看到了一篇能把RSA算法的代码写明白的，他们问我说能不能把代码写成Java版的，我说Java的会看着很费劲，Python代码的直观性在数字计算方面有很大的优势。\n" +
                ...
                "————————————————\n" +
                "版权声明：本文为CSDN博主「北门大官人」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。\n" ;
